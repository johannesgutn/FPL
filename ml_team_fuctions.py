        ...
        for index, row1 in team.iterrows():
            ...
            for index, row2 in team_removed.iterrows():
                ...
                for i in np.arange(high_price,low_price,-1):
                    dft=pred_possible1[pred_possible1.now_cost<=i]
                    dft=dft[pred_possible1.now_cost>i-1]
